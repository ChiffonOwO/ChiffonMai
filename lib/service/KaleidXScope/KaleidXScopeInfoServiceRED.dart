...
class KaleidXScopeInfoServiceRED {
  static final KaleidXScopeInfoServiceRED _instance = KaleidXScopeInfoServiceRED._internal();
  factory KaleidXScopeInfoServiceRED() => _instance;
  KaleidXScopeInfoServiceRED._internal();

  static const String _gateColor = 'red';
  ...
  Future<List<Song>> getRedGateSongs() async {
